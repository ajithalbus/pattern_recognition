...
waste,c1_eigVec=np.linalg.eig(sig)
...
waste,c2_eigVec=np.linalg.eig(sig)
...
waste,c3_eigVec=np.linalg.eig(sig)
...
np.savetxt('../op_data/NLS/r-case4-fa.txt',c_fa)
np.savetxt('../op_data/NLS/r-case4-miss.txt',c_miss)
np.savetxt('../op_data/NLS/r-case4-tp.txt',c_tp)
