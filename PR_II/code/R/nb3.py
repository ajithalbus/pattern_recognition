...
def plotr(mu,sig,color):
    ...
    #ax.set_xlim(mu[0]-4*sig[0][0]**0.5, mu[0]+4*sig[0][0]**0.5)
    #ax.set_ylim(mu[1]-4*sig[1][1]**0.5, mu[1]+4*sig[1][1]**0.5)
...
#plt.plot(*computeEllipse((g1w2[0,0]-g2w2[0,0])/-(g1w2[1,1]-g2w2[1,1]),0,(g1w1[0]-g2w1[0])/-(g1w2[1,1]-g2w2[1,1]),(g1w1[1]-g2w1[1])/-(g1w2[1,1]-g2w2[1,1]),(g1w0-g2w0)/-(g1w2[1,1]-g2w2[1,1])))
...
#x,y=symbols('x y')
#plot_implicit(Eq (x**2*(g1w2[0,0]-g2w2[0,0])+y**2*(g1w2[1,1]-g2w2[1,1])+x*(g1w1[0]-g2w1[0])+y*(g1w1[1]-g2w1[1])+(g1w0-g2w0),0))
...
np.savetxt('../op_data/NLS/r-case5-fa.txt',c_fa)
np.savetxt('../op_data/NLS/r-case5-miss.txt',c_miss)
np.savetxt('../op_data/NLS/r-case5-tp.txt',c_tp)
